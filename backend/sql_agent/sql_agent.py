...
async def run_sql_query(
    ...
    model_settings = {
        "model": "ft:gpt-4o-2024-08-06:fashionai:sql-agent:ApjieCJc",#"ft:gpt-4o-2024-08-06:fashionai:sql:BcGG5WWD",#,#"ft:gpt-4o-2024-08-06:fashionai:sql-agent-python:ALzCsYgL",  # ft:gpt-4o-2024-08-06:fashionai:sql-agent:ALEkyhlL
        "seed": 1841802839,
