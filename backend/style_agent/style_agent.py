...
async def run_style_agent(
    ...
    print("Style Agent", message, "\n\n\n")

    model_settings = {
        "model": "gpt-4o",#"ft:gpt-4o-2024-08-06:fashionai:sql-agent-python:ALzCsYgL",  # ft:gpt-4o-2024-08-06:fashionai:sql-agent:ALEkyhlL
        "seed": 1841802839,
        "tools": style_agent_tools,
    ...
    print("Style Agent Tool Call: ", tool_call, "\n\n\n")
...
async def style_agent(user_input, master_agent_input, sid, message_id, thread_id):
    ...
    while attempts < max_attempts:
        ...
        print("Style Agent Attempt: ", attempts, "\n\n\n")
        # Call the get_sql_query function
        query, output, tool_call_id, tool_history, tool_name = await run_style_agent(
            message, user_input, master_agent_input, sid, message_id, thread_id
        )
